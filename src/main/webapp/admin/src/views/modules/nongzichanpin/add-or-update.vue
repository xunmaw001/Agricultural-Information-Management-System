<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="农资类型" prop="nongzileixing">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="产品特点" prop="chanpintedian">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.chanpintedian" label="产品特点" prop="chanpintedian">
                    <span>{{ruleForm.chanpintedian}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.chanpinxiangqing = this.ruleForm.chanpinxiangqing.replace(reg,'../../../ssm4qh7y/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
