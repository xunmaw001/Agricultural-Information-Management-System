<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="农资类型" prop="nongzileixing">
          <el-input v-model="ruleForm.nongzileixing" 
              placeholder="农资类型" clearable  :readonly="ro.nongzileixing"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="农资类型" prop="nongzileixing">
              <el-input v-model="ruleForm.nongzileixing" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="种植户账号" prop="zhongzhihuzhanghao">
          <el-input v-model="ruleForm.zhongzhihuzhanghao" 
              placeholder="种植户账号" clearable  :readonly="ro.zhongzhihuzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="种植户账号" prop="zhongzhihuzhanghao">
              <el-input v-model="ruleForm.zhongzhihuzhanghao" 
                placeholder="种植户账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="种植户姓名" prop="zhongzhihuxingming">
          <el-input v-model="ruleForm.zhongzhihuxingming" 
              placeholder="种植户姓名" clearable  :readonly="ro.zhongzhihuxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="种植户姓名" prop="zhongzhihuxingming">
              <el-input v-model="ruleForm.zhongzhihuxingming" 
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhongzhihuzhanghao = true;
          ...
          if(o=='zhongzhihuxingming'){
            this.ruleForm.zhongzhihuxingming = obj[o];
	    this.ro.zhongzhihuxingming = true;
            continue;
          }
          if(o=='lianxifangshi'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zhongzhihuzhanghao!=''&&json.zhongzhihuzhanghao){
                this.ruleForm.zhongzhihuzhanghao = json.zhongzhihuzhanghao
	    		this.ro.zhongzhihuzhanghao = true;
		}
		if(json.zhongzhihuxingming!=''&&json.zhongzhihuxingming){
                this.ruleForm.zhongzhihuxingming = json.zhongzhihuxingming
	    		this.ro.zhongzhihuxingming = true;
		}
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `nongzidingdan/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.nongzidingdanCrossAddOrUpdateFlag = false;
						 this.parent.search();
