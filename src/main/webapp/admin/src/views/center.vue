  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhongzhihu'"  label="种植户账号" prop="zhongzhihuzhanghao">
          <el-input v-model="ruleForm.zhongzhihuzhanghao" readonly              placeholder="种植户账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhongzhihu'"  label="种植户姓名" prop="zhongzhihuxingming">
          <el-input v-model="ruleForm.zhongzhihuxingming"               placeholder="种植户姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item v-if="flag=='zhongzhihu'"  label="性别" prop="xingbie">
          <el-select v-model="ruleForm.xingbie"  placeholder="请选择性别">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhongzhihu'"  label="年龄" prop="nianling">
          <el-input v-model="ruleForm.nianling"               placeholder="年龄" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhongzhihu'"  label="联系方式" prop="lianxifangshi">
...
export default {
  ...
  methods: {
    onUpdateHandler() {
      ...
      if((!this.ruleForm.zhongzhihuxingming)&& 'zhongzhihu'==this.flag){
