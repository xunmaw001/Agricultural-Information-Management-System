  ...
  <div>
      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='zhongzhihu'" class="input-group">
			   <div class="label">种植户账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhongzhihuzhanghao" class="input" type="text" placeholder="种植户账号">
			   </div>
			 </div> -->
			<el-form-item label="种植户账号" class="input" v-if="tableName=='zhongzhihu'">
			  <el-input v-model="ruleForm.zhongzhihuzhanghao" autocomplete="off" placeholder="种植户账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongzhihu'" class="input-group">
			   <div class="label">种植户姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhongzhihuxingming" class="input" type="text" placeholder="种植户姓名">
			   </div>
			 </div> -->
			<el-form-item label="种植户姓名" class="input" v-if="tableName=='zhongzhihu'">
			  <el-input v-model="ruleForm.zhongzhihuxingming" autocomplete="off" placeholder="种植户姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongzhihu'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='zhongzhihu'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='zhongzhihu'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='zhongzhihu'">
			  <el-input v-model="ruleForm.nianling" autocomplete="off" placeholder="年龄"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhongzhihu'" class="input-group">
			...
			<el-form-item label="联系方式" class="input" v-if="tableName=='zhongzhihu'">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.zhongzhihuxingming) && `zhongzhihu` == this.tableName){
